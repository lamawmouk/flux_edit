...
class FluxRFInversionPipeline(
    ...
    def __call__(
        ...
        max_sequence_length: int = 512,
        image: Optional[PipelineImageInput] = None,  # Add this parameter
        lambda_weight: float = 0.5,  # Add lambda_weight parameter with default value
    ):
        r"""
        ...
        image, latent_timestep, batch_size * num_images_per_prompt, num_channels_latents,
        ...
        #denoising loop#
        ################
        # Initialize SAM outside the loop for efficiency
        use_attn_mask = True
        save_attn_mask = True
        ...
        sam_model = LangSAM()
        image_tensor = init_image[0].detach().to(torch.float32).cpu()
        ...
        attn_mask, boxes, phrases, logits = sam_model.predict(image_pil, sam_prompt)
...
if __name__ == "__main__":
    ...
    from pipeline_flux_rf_inversion_hat import FluxRFInversionPipeline
   # from diffusers import FluxImg2ImgPipeline
    ...
    main()
"""python /home/hice1/lmoukheiber3/rf_inversion/pipeline_flux_rf_inversion_hat.py  --model "black-forest-labs/FLUX.1-dev" --prompt "change the cat to have green eyes"   --image "/home/hice1/lmoukheiber3/rf_inversion/examples/cat.jpg"   --output "/home/hice1/lmoukheiber3/rf_inversion/results/res.jpg"  """